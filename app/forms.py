...
class GameForm(FlaskForm):
    ...
    size = IntegerField('Generate puzzle with size', default=SIZE, validators=[NumberRange(min=SIZE, message=ERROR_MESSAGE_SIZE)])
    unsolvable = BooleanField("Generate unsolvable puzzle")
    ...
    heuristic = RadioField("Heuristic function", default=HEURISTIC_DEFAULT,
                           choices=HEURISTIC)
    attempt = BooleanField("Attempt to solve unsolvable puzzle")
